...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // --- F u n c t i o n ---
    ...
    SimpleInstallFunction(isolate_, prototype, "myopt_feedback", Builtins::kOptFeedback, 0,
                          false);
    SimpleInstallFunction(isolate_, prototype, "myopt_turbofan",
                          Builtins::kOptTurbofan, 0, false);
